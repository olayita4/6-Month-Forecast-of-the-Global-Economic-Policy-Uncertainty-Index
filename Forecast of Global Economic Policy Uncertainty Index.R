load('C:\\Users\\oscar\\Desktop\\STAT 631\\project.Rdata')
...
# From the plots we can observe that Yt has an upward trend and it seems to be a non stationary random walk process. After taking the difference we can observe that the series has a constant mean, but its variance is not constant. This suggests a log transformation.  
